...
class Top_Bar_Frame():
    ...
    def __init__(self,master):
         ...
         self.robot_name= tk.Label(top_bar_frame, text="Robot's Name  :  " , font=("AnuDaw Regular", 11))
...
class Bottom_Frame():
    ...
    def __init__(self,master):
         ...
         self.top_header_lbl= tk.Label(bottom_fr, width=50, text="Welcome to NAO's world", fg='#6666FF',font=("AnuDaw Regular", 25))
    ...
    def motion_window(self):
         ...
         new_window = Window()
         new_window.center_window(self.motion_window,750,650)
    ...
    def speech_window(self):
         ...
         main_window.withdraw()
         new_window = Window() 
         new_window.center_window(self.speech_window,850,730)
    ...
    def lab_info_window(self):
         ...
         main_window.withdraw()
         new_window = Window() 
         new_window.center_window(self.lab_info_window,540,410)
    ...
    def demo_window(self):
         ...
         main_window.withdraw()
         new_window = Window() 
         new_window.center_window(self.demo_window,425,530)
