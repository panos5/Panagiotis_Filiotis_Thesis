...
#Top    # Declaration of the widgets placed on the buttons frame and packing
        ...
        self.sit_down_bt = tk.Button(self.top_buttons_fr, text="Sit down", width= 8, height=2, wraplength=50 ,relief='raised', bd=5 , command=self.sit_down)
        self.crouch_bt = tk.Button(self.top_buttons_fr, text="Crouch", width= 8, height=2, wraplength=30,relief='raised', bd=5 , command=self.crouch)
        self.stand_up_bt = tk.Button(self.top_buttons_fr, text="Stand up", width= 8, height=2, wraplength=50,relief='raised', bd=5 , command=self.stand_up)
...
#Direct # Declaration of the widgets placed on the directions buttons frame and placing according to a grid geometry
        ...
        self.move_left_bt = tk.Button(self.direction_buttons_fr, text="Move Left", width=8, height=2,relief='raised', wraplength=60, bd=5 , command=self.move_left)
