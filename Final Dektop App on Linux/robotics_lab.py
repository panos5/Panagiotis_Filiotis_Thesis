...
#Links   # Declaration of the elements placed on the links frame and packing    
         ...
         self.news_bt = tk.Button(self.links_fr, text="News", width=7, height=2, wraplength=80,relief='raised', bd=3 , command = lambda : self.open_url(self.news_url) )
         self.research_bt = tk.Button(self.links_fr, text="Research", width=7, height=2, wraplength=80 ,relief='raised', bd=3 ,  command = lambda : self.open_url(self.research_url))
         self.our_group_bt = tk.Button(self.links_fr, text="The Group", width=7, height=2, wraplength=80,relief='raised', bd=3 , command = lambda : self.open_url(self.group_url) )
         self.publications_bt = tk.Button(self.links_fr, text="Publications", width=7, height=2, wraplength=80 ,relief='raised', bd=3 , command = lambda : self.open_url(self.publications_url) )       
         self.robots_bt = tk.Button(self.links_fr, text="Robots", width=7, height=2, wraplength=80 ,relief='raised', bd=3 , command = lambda : self.open_url(self.robots_url) )
         self.services_bt = tk.Button(self.links_fr, text="The Course", width=7, height=2, wraplength=80 ,relief='raised', bd=3, command = lambda : self.open_url(self.services_url) )
