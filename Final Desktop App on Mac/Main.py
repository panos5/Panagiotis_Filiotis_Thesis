...
class Bottom_Frame():
    ...
    def __init__(self,master):
         ...
         self.motion_bt = tk.Button(buttons_fr, text="Motion", width=15, height=3, wraplength=30, relief ="raise" , bd=5 , bg = "#3399FF", fg = "white" , command = self.motion_window )
         self.speech_bt = tk.Button(buttons_fr, text="Speech", width=15, height=3, wraplength=30, relief ="raise" , bd=5 , bg = "#009966" ,  fg = "white" ,  command= self.speech_window)
         self.demonstration_bt = tk.Button(buttons_fr, text="Demonstrations", width=15, height=3, wraplength=90, relief ="raise" , bd=5 , bg = "#9999FF" , fg = "white" ,command = self.demo_window)
         self.lab_info_bt = tk.Button(buttons_fr, text="Robotics Lab Information", width=15, height=3, wraplength=90, relief ="raise" , bd=5 ,   bg = "#CC9966",fg = "white" ,command = self.lab_info_window)
         ...
         self.settings_bt = tk.Button(buttons_fr, text="Settings", width=15, height=3  , wraplength=40, relief ="raise" , bd=5 , bg = "#6633FF"  , fg="white"  , command = self.settings_window)
